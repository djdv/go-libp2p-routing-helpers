...
// Get LibP2P DNS record value from FQDN's TXT
//TODO: opts handling
func (dnsRouter *DNS) GetValue(ctx context.Context, key string, opts ...routing.Option) ([]byte, error) {
...
func (dnsRouter *DNS) SearchValue(ctx context.Context, key string, opts ...routing.Option) (<-chan []byte, error) {
...
// Push LibP2P DNS record value to FQDN for storage
func (dnsRouter *DNS) PutValue(ctx context.Context, key string, value []byte, opts ...routing.Option) error {
